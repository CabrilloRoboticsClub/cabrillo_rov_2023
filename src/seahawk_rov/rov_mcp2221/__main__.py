'''
rov_mcp2221/__main__.py

the main for the node that access the mcp2221 on the rov
...
# library for accessing the mcp2221
import board
import busio
...
def main(args=None):
    ...
    node_seahawk_rov = rclpy.create_node('seahawk_rov_mcp2221')
