...
def main(args=None):
    ...
    def poll_sensors():
        ...
        logic_tube_imu.enable_feature(logic_tube_imu.BNO_REPORT_RAW_ACCELEROMETER)
        message_logic_tube_imu.linear_acceleration = logic_tube_imu.raw_acceleration
        logic_tube_imu.enable_feature(logic_tube_imu.BNO_REPORT_RAW_GYROSCOPE)
        message_logic_tube_imu.angular_velocity = logic_tube_imu.raw_gyro
        logic_tube_imu.enable_feature(logic_tube_imu.BNO_REPORT_RAW_MAGNETOMETER)
